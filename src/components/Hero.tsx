      ...
      <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
        ...
        <div className="w-full md:w-1/2 animate-slide-in-right">
          <div className="relative mx-auto w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-4 border-portfolio-purple shadow-lg">
            <div className="absolute inset-0 bg-gradient-to-br from-portfolio-purple-light to-portfolio-purple flex items-center justify-center text-white">
              <span className="text-lg font-medium">"C:\Users\Shazain\Downloads\IMG-20220302-WA0009.jpg"</span>
            </div>
          </div>
        </div>
      </div>
