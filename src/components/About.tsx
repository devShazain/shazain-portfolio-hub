  ...
  return <section id="about" className="section-padding bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto mb-12 text-center">
          <p className="text-lg text-gray-700 font-normal">I’m passionate about building smart, seamless experiences by fusing creativity with technology. I develop modern web and cross-platform apps powered by AI and emerging tech—so users never waste a second waiting. From HTML, CSS, and React to PHP, Python, and beyond, I bring ideas to life through code. I also love exploring data, uncovering meaningful insights with tools like Power BI to drive better decisions and better products.</p>
        </div>
